...
class Learner(models.Model):
    ...
    def __str__(self): return self.user.username + "," + self.occupation
...
class Course(models.Model):
    ...
    is_enrolled = False
    def __str__(self): return "Name: " + self.name + "," + "Description: " + self.description
...
class Question(models.Model):
    ...
    def __str__(self): return "Question: " + self.content
    def is_get_score(self, selected_ids):
        all_answers = self.choice_set.filter(is_correct=True).count()
        selected_correct = self.choice_set.filter(is_correct=True, id__in=selected_ids).count()
        if all_answers == selected_correct: return True
        else: return False
